...
* The current PFWsense version where the bug first appeared
* The last PFWsense version where the bug did not exist
...
https://pfwsense.org/about/road-map/

Feature requests beyond the scope of PFWsense may still be provided
using the plugin framework:

https://github.com/pfwsense/plugins/issues
...
be directed elsewhere unless specific for PFWsense.
